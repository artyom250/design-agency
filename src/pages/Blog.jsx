...
function Blog() {
  return (
    <div className='Blog'>
      <div className="Page">
        <div className="large">
            <p className="block-head service">Our Blog</p>
            ...
            <div className="blogs">
                ...
                <a href="#">
                    <div className="blog">
                        <div className="b-img">
                            <img src="https://images.unsplash.com/photo-1622547748225-3fc4abd2cca0?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="bog" />
                        </div>
                        <div className="b-flex">
                            <p>Updates</p>
                            <p>September 5, 2023</p>
                ...
                <a href="#">
                    <div className="blog">
                        <div className="b-img">
                            <img src="https://images.unsplash.com/photo-1617791160588-241658c0f566?q=80&w=1964&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="bog" />
                        </div>
                        <div className="b-flex">
                            <p>Tutorial</p>
                            <p>September 5, 2023</p>
                ...
                <a href="#">
                    <div className="blog">
                        <div className="b-img">
                            <img src="https://images.unsplash.com/photo-1617396900799-f4ec2b43c7ae?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="bog" />
                        </div>
                        <div className="b-flex">
                            <p>Articals</p>
                            <p>September 5, 2023</p>
